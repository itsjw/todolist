...
/* WEBPACK VAR INJECTION */(function($) {function prototype() {
    ...
    function setIndex() {
        ...
        var c = $(document).find(':input').length + 1;
        $('.collection').each(function () {

            var $collectionHolder = $(this);
            var collectionId = $(this).data('collection-id');
            var parentItem = $collectionHolder.parents('.item:first').length;
            var parentIndex = $collectionHolder.parents('.item:first').data('index');

            //define the index of the collections
            c++;
            var collectionMainIndex = c;
            if (parentItem === 1) {
    ...
    function addCollection($addBtn) {
        ...
        var collectionId = $addBtn.data('collection-id');

        var index = $addBtn.data('index');

        var $collectionHolder = $addBtn.parents('.' + collectionId + ':first');
        var prototype = $collectionHolder.data('prototype');
        var name = $collectionHolder.data('collection-name');
        var prototypeName = new RegExp(name, 'g');

        //create a new form and append it to the collection
        var newFormData = prototype.replace(prototypeName, index);

        var $newForm = $(newFormData).hide();
    ...
    $(document).on('click', '.remove-collection-item', function (event) {
        ...
        //optional callback function for every collection
        var $thisBtn = $(this);
        var $thisItem = $thisBtn.closest('.item');
